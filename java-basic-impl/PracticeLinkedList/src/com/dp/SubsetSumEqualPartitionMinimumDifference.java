package com.dp;
	...
	public class SubsetSumEqualPartitionMinimumDifference {
		  ...
		  public static void main(String[] args) {
		    ...
		    System.out.println(SubsetSumEqualPartitionMinimumDifference.getMinDifferenceSubsetSumArrayPartition(arr));
