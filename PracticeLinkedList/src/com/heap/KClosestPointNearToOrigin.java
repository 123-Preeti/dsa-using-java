...
public class KClosestPointNearToOrigin {
	...
	public static void main(String[] args) {
		...
		List<Coordinate> kClosestPointsUsingList = KClosestPointNearToOrigin.kClosestPointFromOriginUsingList(listOfCoordinate, 2);
		...
		List<Coordinate> kClosestPointsUsingMinHeap = KClosestPointNearToOrigin.kClosestPointFromOriginUsingMinHeap(listOfCoordinate, 2);
		...
		List<Coordinate> kClosestPointsUsingMaxHeap = KClosestPointNearToOrigin.kClosestPointFromOriginUsingMaxHeap(listOfCoordinate, 2);
