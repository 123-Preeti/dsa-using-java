...
public class TopKFrequentElement {
	...
	public static void main(String[] args) {
		...
		int k = 3;
		System.out.println(TopKFrequentElement.topKFrequentlyOccurredNumbersUsingMinHeap(arr, k));
		System.out.println(TopKFrequentElement.topKFrequentlyOccurredNumbersUsingMaxHeap(arr, k));
	}
